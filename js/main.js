...
button.addEventListener("click", () => { 
  ...
  if (button.children[0].classList.contains("fa-moon")) {
    landing.children[0].classList.add("light");
    landing.children[0].classList.remove("dark");
  } else {
    landing.children[0].classList.remove("light");
    landing.children[0].classList.add("dark");
  }
});