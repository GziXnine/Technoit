...
function getParticlesConfig() {
  ...
  const isMiddileScreen = window.innerWidth <= 992; // Define your breakpoint for small screens
  const particlesCount = isSmallScreen ? 80 : isMiddileScreen ? 150 : 320; // Adjust the number of particles
...
// Initialize particlesJS with the configuration
